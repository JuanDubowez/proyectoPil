...
namespace billeteraVirtual.Models
{
    public class Cuenta
    {
        ...
        public Cuenta(int id_cuenta, int id_cliente, string cvu, string numero_de_cuenta, int saldo, int id_tipo_cuenta)
        {
            Id_cuenta = id_cuenta;
        ...
        public string Numero_de_cuenta { get => numero_de_cuenta; set => numero_de_cuenta = value; }
